...
if (activeConfig && activeConfig.apiKey && activeConfig.apiKey !== "SUA_API_KEY_AQUI") {
  ...
  console.log("Firebase inativo. Rodando em modo LocalStorage (Use o login teste: admin@frassettobolsas.com / admin123)");
}
...
function setupEventListeners() {
  ...
  if (configForm) {
    configForm.addEventListener("submit", (e) => {
      ...
      settings.imgbbKey = document.getElementById("config-imgbb-key").value;
      saveToLocalStorage();
      renderHero();
...
function renderProductDetail(productId) {
  ...
  // Mensagem automática formatada para o WhatsApp
  const whatsappMsg = encodeURIComponent(`Olá, Ateliê Frassetto! Gostaria de conversar sobre a linda bolsa artesanal *${prod.nome}* (${formattedPrice}) que visualizei em sua vitrine digital premium.`);
  ...
  container.innerHTML = `
    ...
    <div class="product-detail-info">
      ...
      <div class="detail-actions">
        <a href="https://wa.me/${WHATSAPP_PHONE}?text=${whatsappMsg}" target="_blank" class="btn-primary detail-whatsapp-btn">
